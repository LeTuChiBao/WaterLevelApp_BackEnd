...
export class UpdateNotifyColumIsReading1728364852890 implements MigrationInterface {
    name = 'UpdateNotifyColumIsReading1728364852890'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "temporary_notify" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "message" varchar NOT NULL, "created_at" datetime NOT NULL DEFAULT (datetime('now')), "readingId" integer, "userId" integer, "isReading" boolean NOT NULL DEFAULT (0), CONSTRAINT "FK_7e728820acd8818fe9638791bcf" FOREIGN KEY ("userId") REFERENCES "user" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION, CONSTRAINT "FK_615a5d170f5ee71fb68e3e96df0" FOREIGN KEY ("readingId") REFERENCES "reading" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION)`);
